...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 pb-6 relative">
        ...
        <div className="sticky top-0 z-10 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 pt-4 sm:pt-6 pb-4 px-4 sm:px-6">
          <div className="text-center mb-4 sm:mb-6">
            ...
            <p className="text-sm sm:text-base text-gray-600">
              ThokMarket के शानदार प्रोडक्ट्स देखें और जानें
            </p>
          </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6 max-w-7xl mx-auto">
              {filteredProducts.map((product, index) => (
                <div
                  key={product._id}
                  onClick={() =>
                    navigate(`/productWithProductType/${product.productType}`)
                  }
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[9999]">
          <div className="bg-white rounded-2xl shadow-2xl p-6 w-80 text-center">
            <h2 className="text-lg font-bold text-gray-800 mb-3">
              क्या आप इस वेबसाइट को इंस्टॉल करना चाहते हैं?
            </h2>
            <p className="text-gray-600 text-sm mb-5">
              इससे आप ThokMarket को सीधे अपने मोबाइल से ओपन कर पाएंगे।
            </p>
